...
max_tdep = date2mjd2000([2040 02 01 00 00 00]);
max_tarr = date2mjd2000([2069 02 01 00 00 00]);
max_tGA = date2mjd2000([2071 02 01 00 00 00]);

% Launch vehicle and probe maximum deltav
LV_max_vinf = 22;       % Maximum hyperbolic excess velocity of launch vehicle [km/s]
SC_max_vinf = 20;       % Maximum deltav of the spacecraft [km/s]
rpmin = 6300;           % Minimum radius of perigee at flyby, sum of radius of the planet and of the atmosphere [km]
