function [alpha, delta, lon, lat] = groundtrack(state_vec, gw_longitude0, t, omega_e,mu,t0);
...
%% Conversion to latitude and longitude (IMPROVEMENT: make as function)
