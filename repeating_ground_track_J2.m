function a_secular = repeating_ground_track_J2(m, k, mu, omega_e, J2,R_e, e, i)
...
%   revolutions, accounting for the SECULAR PERTURBATIONS due to J2
%   
% PROTOTYPE:
...
a_secular = fzero(fun,a0, options);
end
