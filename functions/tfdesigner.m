...
%   windowB[1x2]    Vector with transfer window opening and closing times in
%                 mjd2000 to arrival body; first el. is opening of
%                 transfer window, second el. is closing of transfer window
...
%   dep_orbit[ndep,6] position and velocity vector of optimal departure orbit [km]
%   arr_orbit[narr,6] position and velocity vector of optimal arrival orbit [km]
%
